...
module router::router_tests {
    ...
    fun test_initialization(
        ...
        router_test_helper::e2e_test_setup(movement_names, movement_names, user, &aptos, rando, &foundation);
    ...
    fun test_accept_admin(
        ...
        router::init_module_for_test(router);
        let users = router_test_helper::e2e_test_setup(movement_names, movement_names, user, &aptos, rando, &foundation);
